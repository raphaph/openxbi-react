        ...
        <IntroductionContainer variant={themeValue}>
            ...
            <IntroductionContent>
                <IntroText>
                    ...
                    <p><strong>(OpenXBI) Open New UX for BI -</strong> É um conceito que se refere à criação de experiências de usuário (UX) mais abertas e colaborativas para Business Intelligence (BI). Em outras palavras, significa que as ferramentas de BI devem ser projetadas para permitir uma maior interação e participação dos usuários em todo o processo de análise de dados.</p>
