...
export function Introduction() {
    ...
    return (
        <IntroductionContainer variant={themeValue}>
            ...
            <IntroductionContent>
                <IntroText>
                    {languageSelect === 'pt' ? <><h1>Introdução</h1>
                        ...
                        <>
                            <h1>Introduction</h1>
                            <strong>Component library for compatible tools, and templates for PowerBI.</strong>

                            <p><strong>(OpenXBI) Open - New UX for BI -</strong> It is a concept that refers to the creation of more open and collaborative user experiences (UX) for Business Intelligence (BI). In other words, it means that BI components must be designed to allow greater user interaction and participation throughout the data analysis process.</p>

                            <h2>Vision</h2>
                            <p>As an HTML and CSS component platform, we aim to provide a set of user interface (UI) components for data analysis. These components are designed to be flexible and highly customizable, allowing users to adapt the interface to their specific needs.</p>
                            <p>Styling components in HTML and CSS and allowing the incorporation of the DAX language in their operation are the main differentials that we seek to offer to users. Our goal is to provide highly customizable and useful components while addressing accessibility issues common in BI solutions.</p>



                            <h2>Main features</h2>
                            <p><strong>Dynamism</strong> - Some important elements of PowerBI, for example, are somewhat static, and do not have agile interactivity to bring new information, such as the "Card or Cartão", thinking about it, we created Cards that have interactivity when hovering the mouse over it, bringing new information or even graphs instantly. </p>
                            <p><strong>Accessibility</strong> - We can say that PowerBI is a tool with several accessibility functions, but still some elements leave something to be desired, especially when it comes to Cards and focus on elements. We seek to develop elements that stand out and help with visualization, whether for users with eye damage or for those who do a lot of presentations with a dashboard.</p>
                            <p><strong>Comments</strong> - We seek to comment on the most important and modified parts of a component to help our users during edits or even understand how the component works.</p>
                            <p><strong>DAX</strong> - As mentioned during the introduction, incorporating DAX is the main feature, which we seek to pass on knowledge to users, it is with it that you will be able to do magic with the components. Formatting values, calculating, creating conditionals or iterating, are some of the functions that you can find preconfigured in our templates.</p>

                            <h2>Community</h2>
                            <p>If you have questions, suggestions, want to know about new components and templates, join our Discord.</p>
                            <a href="https://discord.gg/BTgztvKF7E" target={'_blank'} rel="noreferrer">
