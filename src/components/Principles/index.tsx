import { UserFocus, Cube, Faders, ChartBar, TreeStructure, ArrowsClockwise, PresentationChart, BoundingBox, LockKey, CursorText, Cursor } from "phosphor-react";
    ...
    return (
        <PrinciplesContainer>
            <PrinciplesTitle>
                ...
                <strong>Aqui estão alguns dos principios que na OpenXBI acreditamos que todo análista de dados deve seguir.</strong>
            </PrinciplesTitle>
            <PrinciplesContent>
                <div>
